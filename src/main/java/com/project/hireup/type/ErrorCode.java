...
public enum ErrorCode {
  ...
  CAN_NOT_DELETE_COMMENT(HttpStatus.BAD_REQUEST, "해당 댓글을 삭제할 수 있는 권한이 없습니다."),
  INVALID_PASSWORD(HttpStatus.BAD_REQUEST, "비밀번호가 올바르지 않습니다."),
  PRIVATE_POST(HttpStatus.BAD_REQUEST, "비공개 게시글입니다."),
  NOT_FOLLOWER(HttpStatus.BAD_REQUEST, "팔로워만 가능합니다."),
  NOT_COMMENT_OWNER(HttpStatus.BAD_REQUEST, "작성자만 가능한 동작입니다."),
